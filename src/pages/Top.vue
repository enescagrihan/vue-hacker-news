...
<template>
  <div style="padding-top: 12px">
    <div v-for="(item, index) in topStoryState" :key="index">
...
export default {
  ...
  methods: {
    ...
    ...mapMutations(['topStoriesMoreButtonClickIncrease', 'emptyMoreButtonClicks']),
  ...
  computed: { ...mapState(['topStoryState', 'moreButtonClicks']) },
};
</script>
